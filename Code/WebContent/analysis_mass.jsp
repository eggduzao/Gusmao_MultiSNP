						...
						<h:form id="formAnalysis" styleClass="form" enctype="multipart/form-data" >
		                    ...
		                    <div class="comprimento-4 primeiro">
		                        <div id="parameter-title" class="param-title" onclick="openOrCloseParameters();" onmouseover="highlight();" onmouseout="fadelight();">
		                        	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Advanced MASS Parameters
		                        </div>
		                    </div>
		                    
		                    <div id="mass-parameter" class="form" style="display: none;">
		                    ...
		                    <div class="comprimento-6 primeiro">
		                        <h:commandButton type="submit" id="botaoAnalyze" styleClass="button" value="Analyze" action="#{analysisBean.result}" onclick="return check();">
		                        	<f:param id="method" name="method" value="mass"/>
		                        </h:commandButton>
		                    </div>
