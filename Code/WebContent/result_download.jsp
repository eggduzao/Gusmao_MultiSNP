        ...
        <div id="content">
            ...
            <div id="main-content">
				...
				<div id="download-result">
					...
					Download Options:<br>
					<ul>
						<li><b>Excel XLS Format: </b>Parameters, Results (SNP Ranking), Time Analysis and Pathway Analysis (if requested) are in each spreadsheet of an excel file. The values are all in text format (but easily changed to numeric format for chart creation or other purposes).</li>
						<br>
						<li><b>Simple TXT Format: </b>Parameters, Results (SNP Ranking), Time Analysis and Pathway Analysis (if requested) comes under each other in simple text format. The format is easier to be read on further analysis.</li>
					</ul>
					...
					<f:view>
						...
						<h:form id="center-form-download">
							<h:commandButton id="botaoDownloadXls" value="Download Excel" styleClass="button-download" action="#{downloadBean.downloadXls}"/>
							<h:commandButton id="botaoDownloadTxt" value="Download Text" styleClass="button-download" action="#{downloadBean.downloadTxt}"/>
							<h:commandButton id="botaoReturn" value="Return" styleClass="button-download" action="#{downloadBean.returnToAnalysis}"/>
						</h:form>
