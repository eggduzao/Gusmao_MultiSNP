...
<html>
    ...
    <body id="result-pia" onload="renderPathwayPIA();">
				...
				<div id="pia-result">
					...
					<f:view>
						...
						<div id="half-container">
							...
							<div id="half-scroll">
								<h:dataTable value="#{resultBean.generalPlusPiaParamList}" var="dataItem" id="half-table-param" rowClasses="list-row-even,list-row-odd">
								    <h:column>
						...
						<div id="half-container">
							...
							<div id="half-scroll">
								<h:dataTable value="#{resultBean.piaTimeList}" var="dataItem" id="half-table-time" rowClasses="list-row-even,list-row-odd">
								    <h:column>
								    	<f:facet name="header"></f:facet>
								        <h:outputText value="#{dataItem.t1}" style="font-weight: bold;"/>
										<h:outputText value="#{dataItem.t2}" />   
						...
						<div id="full-container">
							...
							<div id="full-scroll">
								<h:dataTable value="#{resultBean.piaResultList}" var="dataItemS" id="full-table-snps" rowClasses="list-row-even,list-row-odd">
								    
								    <h:column>
								        <f:facet name="header">
								            <h:outputText value="%Correct"/>
								        </f:facet>
								        <h:outputText value="#{dataItemS.piaCorrectSnps}" style="font-weight: bold;"/>
								        <f:verbatim><br></f:verbatim>
										<h:outputText value="#{dataItemS.piaCorrectScore}"/> 
								    </h:column>
								    
								    <h:column>
								        <f:facet name="header">
								            <h:outputText value="Sens+Spec"/>
								        </f:facet>
								        <h:outputText value="#{dataItemS.piaSsSnps}" style="font-weight: bold;"/>
								        <f:verbatim><br></f:verbatim>
										<h:outputText value="#{dataItemS.piaSsScore}"/>   
								    </h:column>
								    
								    <h:column>
								        <f:facet name="header">
								            <h:outputText value="Ppv+Npv"/>
								        </f:facet>
								        <h:outputText value="#{dataItemS.piaPpvNpvSnps}" style="font-weight: bold;"/>  
								        <f:verbatim><br></f:verbatim>
										<h:outputText value="#{dataItemS.piaPpvNpvScore}"/>   
								    </h:column>
								    ...
								    <h:column>
								        ...
								        <h:outputText value="#{dataItemS.piaRiskSnps}" style="font-weight: bold;"/>  
								        <f:verbatim><br></f:verbatim>
										<h:outputText value="#{dataItemS.piaRiskScore}"/>   
								    </h:column>
								    
								    <h:column>
								        <f:facet name="header">
								            <h:outputText value="Odds"/>
								        </f:facet>
								        <h:outputText value="#{dataItemS.piaOddsSnps}" style="font-weight: bold;"/>  
								        <f:verbatim><br></f:verbatim>
										<h:outputText value="#{dataItemS.piaOddsScore}"/>   
								    </h:column>
								    ...
								    <h:column>
								        ...
								        <h:outputText value="#{dataItemS.piaGiniSnps}" style="font-weight: bold;"/> 
								        <f:verbatim><br></f:verbatim> 
										<h:outputText value="#{dataItemS.piaGiniScore}"/>   
								    </h:column>
								    ...
								    <h:column>
								        ...
								        <h:outputText value="#{dataItemS.piaApdSnps}" style="font-weight: bold;"/>  
								        <f:verbatim><br></f:verbatim>
										<h:outputText value="#{dataItemS.piaApdScore}"/>   
								    </h:column>
						...
						<div id="full-container-pathway" style="display:none;">
							...
							<div id="full-scroll">
								<h:dataTable value="#{resultBean.piaPathwayList}" var="dataItemS" id="full-table-pathway" rowClasses="list-row-even,list-row-odd">
