...
<html>
    ...
    <body id="result-mdr" onload="renderPathwayMDR();">
				...
				<div id="mdr-result">
					...
					<f:view>
						...
						<div id="half-container">
							...
							<div id="half-scroll">
								<h:dataTable value="#{resultBean.generalPlusMdrParamList}" var="dataItem" id="half-table-param" rowClasses="list-row-even,list-row-odd">
								    <h:column>
						...
						<div id="half-container">
							...
							<div id="half-scroll">
								<h:dataTable value="#{resultBean.mdrTimeList}" var="dataItem" id="half-table-time" rowClasses="list-row-even,list-row-odd">
								    <h:column>
								    	<f:facet name="header"></f:facet>
								        <h:outputText value="#{dataItem.t1}" style="font-weight: bold;"/>  
										<h:outputText value="#{dataItem.t2}"/>   
						...
						<div id="third-spacing-removepathwaygap" style="display: none;"></div>
						
						<div id="third-container">
							<div id="snps-title">SNP Combination Ranking</div>
							<div id="third-scroll">
								<h:dataTable value="#{resultBean.mdrResultList}" var="dataItemS" id="third-table-snps" rowClasses="list-row-even,list-row-odd">
								    
								    <h:column>
								        <f:facet name="header">
								            <h:outputText value="Balanced Accuracy"/>
								        </f:facet>
						...
						<div id="third-container">
							<div id="predict-title">Prediction</div>
							
							<div id="third-scroll">
								<div id="predict-values">
									<h:outputText value="Classification Mean:" style="font-weight: bold;"/>
									<h:outputText value="#{resultBean.meanBalancedAccTrain}"/> <br> 
									<h:outputText value="Prediction Mean:" style="font-weight: bold;"/>
									<h:outputText value="#{resultBean.meanBalancedAccTest}"/> <br> 
								</div>
								<h:dataTable value="#{resultBean.balancedAccTest}" var="dataItem" id="third-table-predict" rowClasses="list-row-even,list-row-odd">
						...
						<div id="third-container-pathway" style="display: ">
							<div id="pathway-title">Pathway Analysis</div>
							<div id="third-scroll">
								<h:dataTable value="#{resultBean.mdrPathwayList}" var="dataItemS" id="third-table-pathway" rowClasses="list-row-even,list-row-odd">
