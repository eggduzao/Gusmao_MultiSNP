...
<html>
    ...
    <body id="result-esnp2" onload="renderPathwayESNP2();">
				...
				<div id="esnp2-result">
					...
					<f:view>
						...
						<div id="half-container">
							...
							<div id="half-scroll">
								<h:dataTable value="#{resultBean.generalPlusEsnp2ParamList}" var="dataItem" id="half-table-param" rowClasses="list-row-even,list-row-odd">
								    <h:column>
						...
						<div id="half-container">
							...
							<div id="half-scroll">
								<h:dataTable value="#{resultBean.esnp2TimeList}" var="dataItem" id="half-table-time" rowClasses="list-row-even,list-row-odd">
								    <h:column>
								    	<f:facet name="header"></f:facet>
								        <h:outputText value="#{dataItem.t1}" style="font-weight: bold;"/>  
										<h:outputText value="#{dataItem.t2}"/>   
						...
						<div id="half-container">
							...
							<div id="half-scroll">
								<h:dataTable value="#{resultBean.esnp2ResultList}" var="dataItemS" id="half-table-snps" rowClasses="list-row-even,list-row-odd">
								    <h:column>
								    	<f:facet name="header"> 
								    		<h:outputText value="Delta R"/>
								    	</f:facet>
						...
						<div id="half-container-pathway" style="display: ">
							...
							<div id="half-scroll">
								<h:dataTable value="#{resultBean.esnp2PathwayList}" var="dataItemS" id="half-table-pathway" rowClasses="list-row-even,list-row-odd">
								    <h:column>
								    	<f:facet name="header"> 
								    		<h:outputText value="Delta R"/>
								    	</f:facet>
