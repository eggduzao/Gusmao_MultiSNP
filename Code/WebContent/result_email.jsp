        ...
        <div id="content">
            ...
            <div id="main-content">
				...
				<div id="email-result">
					...
					When the analysis terminates an email will be send with two attachments:
					<ul>
					...
					<f:view>
						...
						<h:form id="center-form-email">
							<h:commandButton id="botaoReturn" value="Return" styleClass="button" action="#{emailBean.returnToAnalysis}"/>
						</h:form>
