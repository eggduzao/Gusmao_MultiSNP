...
public class Arquivo {
    ...
    */
    public Arquivo(String in, String out) {
        try {
        	// Keep Track of the in and out names
        	this.inString = in;
        	this.outString = out;
    ...
    public Arquivo(File in, String out) {
        try {
        	// Keep Track of the in and out names
        	this.inString = in.getCanonicalPath();
        	this.outString = out;
    ...
    /**
     * Creates a new Arquivo Object
     */
    @Override
    public Arquivo clone(){
    	return new Arquivo(this.inString, this.outString);
    }
